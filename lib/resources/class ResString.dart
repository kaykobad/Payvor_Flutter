class ResString {
  ...
  'swipe' : 'Swipe and Select',
    ...
    'enter_your_email':
        'Enter your email and receive a code to reset your password',
    ...
    'post_favor': 'Post Task',
    'update_favor': 'Update Task',
    'apply_filters': 'Apply Filters',
    'enter_new_pass': 'Enter the new password ',
    'post_favour': 'Post a Task',
    ...
    'location': 'Location',
    'preview_favor': 'Preview Task',
    'payment': 'Payment',
    'distance': 'Distance',
    'create_account_button': 'CREATE',
    'filters': 'Filters',
    'reset': 'Reset',
    'job_payment': 'Task payment',
    'payvor_service_fee': 'Perimity service fee ',
    'you_all_receive': 'You’ll receive',
    'apply_for_fav': 'Apply for Task',
    ...
    'no_favours':'No Tasks!\n\nNo one have posted task in your area yet. Be the first.'
