...
class _LoginScreenState extends State<LoginScreenNew> {
  ...
  get loginWith => new Container(
        margin: new EdgeInsets.only(left: 20.0, right: 20.0, top: 32),
        child: new Row(
          children: [
            Expanded(
              child: new Container(
            ...
            new Container(
              ...
              child: new Text(
                "OR LOGIN WITH",
                style:
                    new TextStyle(color: AppColors.lightGrayNew, fontSize: 12),
              ),
            ),
            Expanded(
              child: new Container(
  ...
  get checkBoxData => new Container(
        margin: new EdgeInsets.only(left: 20.0, right: 20.0),
        child: Row(
          children: <Widget>[
            Container(
              ...
              decoration: boolCheckBox
                  ...
                  : new BoxDecoration(
                      ...
                      border: new Border.all(
                          color: Colors.grey.withOpacity(0.6), width: 1.6)),
              width: 20,
              height: 20,
            ),
            new SizedBox(
            ...
            Expanded(
                child: InkWell(
                    ...
                    child: new Text(ResString().get('remember_me'),
